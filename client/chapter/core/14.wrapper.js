...
/*동작원리
String{}이라는 특별한 래퍼 객체가 생성됩니다.
이 객체는 자료형 값을 알고 있습니다.
객체이기 때문에 점 접근법으로 인해 래퍼 객체 내에 있는 split이라는 Method를 동작시킬 수 있습니다.
동작시키고 값을 반환한 다음 래퍼 객체는 삭제되고 다시 원시값으로 돌려놓습니다.
*/
