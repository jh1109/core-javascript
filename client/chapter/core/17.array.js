...
// 배열 선언
let friends = '춘식,라이언,복숭아,레오,주희'.split(',')
console.log(friends);
...
// 배열 요소 추가
let unshift = friends.unshift('고영희');
console.log(friends);
let push = friends.push('승남이');
console.log(friends);


// 배열 요소 제거
let shift = friends.shift('고영희');
console.log(friends);
let pop = friends.pop('승남이');
console.log(friends);
...
//진짜 복사하려면 let copiedArray= [...friends]
